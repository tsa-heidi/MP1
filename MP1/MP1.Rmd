...
for(i in 1:10){
    ...
    fitted_spline_model <- smooth.spline(x = trainData$LotArea, y = trainData$SalePrice, df = 5)
    ...
    RMSLE_list <- c(RMSE_list, RMSE_hat)

#find the average RMSE
avg_RMSE = mean(RMSLE_list)   


    #from here cross validation has been implimented for k=10. from here we need to get the average RMSLE of
    #the entire output. after we do this we can start playing with the df and start comparing the different
    #RMSLE values we get
